...
public class King extends ChessPiece {
    ...
    public boolean[][] possibleMoves() {
        ...
        castlingKingSideRook(mat);
        castlingQueenSideRook(mat);
        return mat;
    }

    private void castlingQueenSideRook(boolean[][] mat) {
    ...
    private void castlingKingSideRook(boolean[][] mat) {
        if (getMoveCount() > 0 || chessMatch.getCheck()) {
            return;
        }
    ...
    private boolean testRookCastling(Position rookPosition) {
        ChessPiece p = (ChessPiece) getBoard().piece(rookPosition);
